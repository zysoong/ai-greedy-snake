...
class Driver:
    ...
    def random_action_map(self):
        ...
        action_map = np.negative(np.ones((self.greedysnake.SIZE, self.greedysnake.SIZE)))
    ...
    def drive(self):
        ...
        for e in range(self.max_epochs):
            ...
            for i in range(self.max_steps):
                ...
                print(display)
                #print(np.array(actmap_t_add_1).reshape((self.greedysnake.SIZE, self.greedysnake.SIZE)))
            ...
            critic_hist = critic_model.fit(s_a, t, epochs=self.critic_net_epochs, verbose=1, batch_size = 64)
            actor_hist = adhdp.fit(s, t, epochs=self.actor_net_epochs, verbose=1, batch_size = 64)
